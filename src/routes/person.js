...
const queues = {
  com: { requestQueue: [], isProcessing: false, scrapeFunction: scrapePerson },
  gov: {
    requestQueue: [],
    isProcessing: false,
    scrapeFunction: scrapePerson,
  },
};
